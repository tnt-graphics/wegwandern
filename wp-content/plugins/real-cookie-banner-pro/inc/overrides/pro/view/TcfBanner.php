...
class TcfBanner
{
    ...
    {
        return Core::getInstance()->getCompLanguage()->translateArray(['tcf' => ['teaching' => \_x('You also allow data transfer under the TCF standard to {{consentCount}} based on consent, and {{legIntCount}} based on legitimate interest, for the following purposes:', 'legal-text', 'real-cookie-banner'), 'vendorList' => \_x('Vendor list', 'legal-text', 'real-cookie-banner'), 'vendors' => \_x('Vendors', 'legal-text', 'real-cookie-banner'), 'vendorsCount' => [\_x('partner', 'legal-text', 'real-cookie-banner'), \_x('partners', 'legal-text', 'real-cookie-banner')], 'dataRetentionPeriod' => \_x('data retention period', 'legal-text', 'real-cookie-banner'), 'example' => \__('Example', 'real-cookie-banner'), 'legIntClaim' => \__('Explanation of the legitimate interest', 'real-cookie-banner'), 'filterText' => \_x('Data processing on the legal basis of:', 'legal-text', 'real-cookie-banner'), 'filterNoVendors' => \_x('No vendor requests purposes under this legal basis.', 'legal-text', 'real-cookie-banner'), 'standard' => \_x('Data processing standardized according to TCF', 'legal-text', 'real-cookie-banner'), 'standardDesc' => \_x('The Transparency & Consent Framework (TCF) is a standard for obtaining consistent consent for processing of personal data and cookie setting. This should enable all parties in the digital (advertising) chain to ensure that they set, process and store data and cookies in accordance with the GDPR and the ePrivacy Directive.', 'legal-text', 'real-cookie-banner'), 'declarations' => [StackCalculator::DECLARATION_TYPE_PURPOSES => ['title' => \_x('Purposes', 'legal-text', 'real-cookie-banner'), 'desc' => \_x('Purposes describe for which purpose which providers may set cookies and process personal data. Purposes are pre-selected if there is a legitimate interest for its data processing. For all other purposes, data will only be processed with explicit consent.', 'legal-text', 'real-cookie-banner')], StackCalculator::DECLARATION_TYPE_SPECIAL_PURPOSES => ['title' => \_x('Special purposes', 'legal-text', 'real-cookie-banner'), 'desc' => \_x('Special purposes for setting cookies and processing personal data by our vendors describe purposes for which we have a legitimate interest that cannot be rejected. For example, we need to process data to prevent fraud.', 'legal-text', 'real-cookie-banner')], StackCalculator::DECLARATION_TYPE_FEATURES => ['title' => \_x('Features', 'legal-text', 'real-cookie-banner'), 'desc' => \_x('Features for processing personal data describe how data is used to fulfill one or more purposes. Features cannot be opted out, but in the "Purposes" section, purposes that lead to the use of features can be selected or deselected. Any purpose can lead to features being used.', 'legal-text', 'real-cookie-banner')], StackCalculator::DECLARATION_TYPE_SPECIAL_FEATURES => ['title' => \_x('Special features', 'legal-text', 'real-cookie-banner'), 'desc' => \_x('Special features for processing personal data describe how data is used to fulfill one or more purposes in a profound way. Personal data will only be processed in this way with explicit consent.', 'legal-text', 'real-cookie-banner')], StackCalculator::DECLARATION_TYPE_DATA_CATEGORIES => ['title' => \_x('Data categories', 'legal-text', 'real-cookie-banner'), 'desc' => \_x('Data categories describe which data is used and obtained while processing personal data.', 'legal-text', 'real-cookie-banner')]]]], [], null, ['legal-text']);
    }
    /**
    ...
    {
        $notice = \sprintf('<div class="notice notice-info inline below-h2 notice-alt" style="margin: 10px 0 0 0"><p>%s</p></div>', \__('You currently have TCF mode enabled. Therefore, you are not allowed to change the font size and font thickness for this button.', 'real-cookie-banner'));
    ...
    public function customizeButtonContrastRatioValidator(&$sections)
    {
        ...
        // translators:
        $message = \__('Your current contrast ratio between background and font color (%1$s) does not reach the minimum of %2$s. Please adjust your colors!', 'real-cookie-banner');
        // Accept all
