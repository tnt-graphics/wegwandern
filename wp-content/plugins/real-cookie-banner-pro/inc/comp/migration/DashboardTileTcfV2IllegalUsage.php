...
class DashboardTileTcfV2IllegalUsage extends \DevOwl\RealCookieBanner\comp\migration\AbstractDashboardTileMigration
{
    ...
    {
        return \__('Consents obtained via TCF illegal', 'real-cookie-banner');
    }
    // Documented in AbstractDashboardTileMigration
    public function getDescription()
    {
        return \__('We need to inform you that on Feb. 02, 2022, the Belgian Data Protection Authority (APD) declared the collection of consents under the Transparency & Consent Framework (TCF) to be invalid. The decision is effective across the EU as it was issued in a one-stop-shop procedure.', 'real-cookie-banner');
    }
    // Documented in AbstractDashboardTileMigration
