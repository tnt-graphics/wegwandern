...
class SaveButton
{
    ...
    {
        return ['name' => 'saveButton', 'title' => \__('"Save" button', 'real-cookie-banner'), 'controls' => [self::SETTING_USE_ACCEPT_ALL => ['name' => 'useAcceptAll', 'label' => \__('Use the same stylings as for "Accept all"', 'real-cookie-banner'), 'description' => \sprintf(
            // translators:
        ...
        ), 'type' => 'checkbox', 'setting' => ['default' => self::DEFAULT_USE_ACCEPT_ALL, 'sanitize_callback' => [AbstractCustomizePanel::class, 'sanitize_checkbox']]], self::SETTING_TYPE => ['name' => 'type', 'label' => \__('Type', 'real-cookie-banner'), 'type' => 'radio', 'choices' => ['button' => \__('Button', 'real-cookie-banner'), 'link' => \__('Link', 'real-cookie-banner')], 'setting' => ['default' => self::DEFAULT_TYPE]], self::SETTING_PADDING => ['class' => CssMarginInput::class, 'name' => 'padding', 'label' => \__('Padding', 'real-cookie-banner'), 'description' => \__('Define the inner distance of the button.', 'real-cookie-banner'), 'dashicon' => 'editor-contract', 'setting' => ['default' => self::DEFAULT_PADDING]], self::SETTING_BG => ['name' => 'bg', 'class' => WP_Customize_Color_Control::class, 'label' => \__('Background color', 'real-cookie-banner'), 'setting' => ['default' => self::DEFAULT_BG, 'sanitize_callback' => 'sanitize_hex_color']], self::SETTING_TEXT_ALIGN => ['name' => 'textAlign', 'label' => \__('Text align', 'real-cookie-banner'), 'type' => 'select', 'choices' => BodyDesign::getTextAlignChoices(), 'setting' => ['default' => self::DEFAULT_TEXT_ALIGN]], self::HEADLINE_FONT => ['class' => Headline::class, 'name' => 'saveButtonFont', 'label' => \__('Font', 'real-cookie-banner')], self::SETTING_FONT_SIZE => ['name' => 'fontSize', 'label' => \__('Size', 'real-cookie-banner'), 'class' => RangeInput::class, 'unit' => 'px', 'input_attrs' => ['min' => 10, 'max' => 30, 'step' => 0], 'setting' => ['default' => self::DEFAULT_FONT_SIZE, 'sanitize_callback' => 'absint']], self::SETTING_FONT_COLOR => ['name' => 'fontColor', 'class' => WP_Customize_Color_Control::class, 'label' => \__('Color', 'real-cookie-banner'), 'setting' => ['default' => self::DEFAULT_FONT_COLOR, 'sanitize_callback' => 'sanitize_hex_color']], self::SETTING_FONT_WEIGHT => ['name' => 'fontWeight', 'label' => \__('Font weight', 'real-cookie-banner'), 'type' => 'select', 'choices' => BodyDesign::getFontWeightChoices(), 'setting' => ['default' => self::DEFAULT_FONT_WEIGHT]], self::HEADLINE_BORDER => ['class' => Headline::class, 'name' => 'saveButtonBorder', 'label' => \__('Border', 'real-cookie-banner')], self::SETTING_BORDER_WIDTH => ['name' => 'borderWidth', 'class' => RangeInput::class, 'unit' => 'px', 'input_attrs' => ['min' => 0, 'max' => 100, 'step' => 1], 'label' => \__('Border width', 'real-cookie-banner'), 'setting' => ['default' => self::DEFAULT_BORDER_WIDTH, 'sanitize_callback' => 'absint']], self::SETTING_BORDER_COLOR => ['name' => 'borderColor', 'class' => WP_Customize_Color_Control::class, 'label' => \__('Color', 'real-cookie-banner'), 'setting' => ['default' => self::DEFAULT_BORDER_COLOR, 'sanitize_callback' => 'sanitize_hex_color']], self::HEADLINE_HOVER => ['class' => Headline::class, 'name' => 'saveButtonHover', 'label' => \__('Transition on hover', 'real-cookie-banner'), 'description' => \__('When the user moves the mouse over the button/link, it changes its color.', 'real-cookie-banner')], self::SETTING_HOVER_BG => ['name' => 'hoverBg', 'class' => WP_Customize_Color_Control::class, 'label' => \__('Background color', 'real-cookie-banner'), 'setting' => ['default' => self::DEFAULT_HOVER_BG, 'sanitize_callback' => 'sanitize_hex_color']], self::SETTING_HOVER_FONT_COLOR => ['name' => 'hoverFontColor', 'class' => WP_Customize_Color_Control::class, 'label' => \__('Font color', 'real-cookie-banner'), 'setting' => ['default' => self::DEFAULT_HOVER_FONT_COLOR, 'sanitize_callback' => 'sanitize_hex_color']], self::SETTING_HOVER_BORDER_COLOR => ['name' => 'hoverBorderColor', 'class' => WP_Customize_Color_Control::class, 'label' => \__('Border color', 'real-cookie-banner'), 'setting' => ['default' => self::DEFAULT_HOVER_BORDER_COLOR, 'sanitize_callback' => 'sanitize_hex_color']]]];
    }
}
