...
$html = '<section class="weg-map-main-wrapper">
		...
		<div class="mapView hide" id="map-resp" style="width: 100%; height: 500px;">
		    ...
		    <div class="map_filter">
		        <div class="map_filter_inner_wrapper">
		            ...
		            <div class="panel">
		                <div class="fc_check_wrap">
		                    <label class="check_wrapper">' . __( 'ÖV-Haltestellen', 'wegwandern' ) . '<input type="checkbox" name="" id="transport_layer_checkbox" value=""><span class="redmark"></span></label><label class="check_wrapper">' . __( 'Gesperrte Wanderwege', 'wegwandern' ) . '<input type="checkbox" id="closure_hikes_layer" name="" value=""><span class="redmark"></span></label><label class="check_wrapper">' . __( 'Hangneigungen über 30°', 'wegwandern' ) . '<input type="checkbox" id="slope_30_layer" name="" value=""><span class="redmark"></span></label><label class="check_wrapper ">' . __( 'Wildruhezonen', 'wegwandern' ) . '<input type="checkbox" id="wildlife_layer" name="" value=""><span class="redmark"></span></label><label class="check_wrapper hide">' . __( 'Wegpunkte WegWandern.ch', 'wegwandern' ) . '<input type="checkbox" name="" value=""><span class="redmark"></span></label>
		                </div>
		            </div>
		        </div>
		    </div>
	...
	<div class="mapView" id="map_desktop" style="width: 100%; height: 500px;">
		...
		<div class="botom_layer_icon">
			...
			<div class="map_filter"><div class="map_filter_inner_wrapper"><div class="accordion">' . __( 'Karteninformationen', 'wegwandern' ) . '</div><div class="panel"><div class="fc_check_wrap"><label class="check_wrapper">' . __( 'ÖV-Haltestellen', 'wegwandern' ) . '<input type="checkbox" name="" id="transport_layer_checkbox" value=""><span class="redmark"></span></label><label class="check_wrapper">' . __( 'Gesperrte Wanderwege', 'wegwandern' ) . '<input type="checkbox" name="" id="closure_hikes_layer" value=""><span class="redmark"></span></label><label class="check_wrapper">' . __( 'Hangneigungen über 30°', 'wegwandern' ) . '<input type="checkbox" id="slope_30_layer" name="" value=""><span class="redmark"></span></label><label class="check_wrapper">' . __( 'Wildruhezonen', 'wegwandern' ) . '<input type="checkbox" id="wildlife_layer" name="" value=""><span class="redmark"></span></label><label class="check_wrapper hide">' . __( 'Wegpunkte WegWandern.ch', 'wegwandern' ) . '<input type="checkbox" name="" value=""><span class="redmark"></span></label></div></div></div></div>
		</div>
