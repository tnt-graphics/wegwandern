...
if ( $region_type == 'wander-slider' ) {
	...
	if ( ! empty( $verlinkungen_auswahlen ) ) {
		...
		foreach ( $verlinkungen_auswahlen as $reg ) {
			$hike_id = $reg->ID
			?>
			<div class="weg-map-popup-outter">
				<div id="weg-map-popup<?php echo $reg->ID; ?>" >
					<div class="map-fixed-position">
					<div id="weg-map-popup-inner-wrapper<?php echo $reg->ID; ?>">
						...
						<div class="map_filter_inner_wrapper">
							...
							<div class="fc_check_wrap">
								...
								<span class="redmark"></span>
								<div class="info_icon" onclick="infoIconClicked(event,&quot;weg-map-popup<?php echo $reg->ID; ?>&quot;)"></div>
								</label>
					...
					<div class="snow_info_details hide">
									<div class="snow_inner_wrapper">
										<div class="snow_close_wrapper" onclick="infoIconClosed(event,&quot;weg-map-popup<?php echo $reg->ID; ?>&quot;)"><div class="snow_close"></div></div>
